...
BOOST_FIXTURE_TEST_CASE(IsPTransf, Fix) {
    ...
    BOOST_TEST(is_partial_transformation(PPa));
    BOOST_TEST(is_partial_transformation(PPa, 6));
    BOOST_TEST(is_partial_transformation(PPa, 5));
    BOOST_TEST(not is_partial_transformation(PPa, 4));
    BOOST_TEST(not is_partial_transformation(PPa, 1));
    BOOST_TEST(not is_partial_transformation(PPa, 0));

    BOOST_TEST(is_partial_transformation(RandT));
    BOOST_TEST(is_partial_transformation(RandT, 16));
    BOOST_TEST(not is_partial_transformation(RandT, 15));
}
...
BOOST_FIXTURE_TEST_CASE(IsTransf, Fix) {
    ...
    BOOST_TEST(is_transformation(PPa));
    BOOST_TEST(is_transformation(PPa, 6));
    BOOST_TEST(is_transformation(PPa, 5));
    BOOST_TEST(not is_transformation(PPa, 4));
    BOOST_TEST(not is_transformation(PPa, 1));
    BOOST_TEST(not is_transformation(PPa, 0));

    BOOST_TEST(is_transformation(RandT));
    BOOST_TEST(is_transformation(RandT, 16));
    BOOST_TEST(not is_transformation(RandT, 15));
}
...
BOOST_FIXTURE_TEST_CASE(IsPerm, Fix) {
    ...
    BOOST_TEST(is_permutation(PPa));
    BOOST_TEST(is_permutation(PPa, 6));
    BOOST_TEST(is_permutation(PPa, 5));
    BOOST_TEST(not is_permutation(PPa, 4));
    BOOST_TEST(not is_permutation(PPa, 1));
    BOOST_TEST(not is_permutation(PPa, 0));

    BOOST_TEST(is_permutation(RandT));
    BOOST_TEST(is_permutation(RandT, 16));
    BOOST_TEST(not is_permutation(RandT, 15));
}
