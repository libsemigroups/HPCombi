...
std::string cpu_x86::get_proc_string(){
	...
	int model = ((CPUInfo[0] >> 4) & 0xF) + ((CPUInfo[0] >> 16) & 0xF); // Looks like model is not the right number
	name = std::to_string( family ) + "." + std::to_string( model );
    return name;
}
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
...
std::string cpu_x86::get_highest_SIMD(){
    cpu_x86 features;
    features.detect_host();
    std::string out;
	if(features.HW_AVX512_F)
		out = "AVX512";
	else if(features.HW_AVX2)
		out = "AVX2";
    else if(features.HW_AVX)
		out = "AVX";
    else if(features.HW_SSE42)
		out = "SSE42";
    else if(features.HW_SSE41)
		out = "SSE41";
    else if(features.HW_SSE4a)
		out = "SSE4a";
    else if(features.HW_SSSE3)
		out = "SSSE3";
    else if(features.HW_SSE3)
		out = "SSE3";
    else if(features.HW_SSE2)
		out = "SSE2";
    else if(features.HW_SSE)
		out = "SSE";
    return out;
}
////////////////////////////////////////////////////////////////////////////////
